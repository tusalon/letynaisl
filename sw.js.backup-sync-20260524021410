...
const CACHE_NAME = 'letynaisl-v25';
const urlsToCache = [
  '/letynaisl/',
  '/letynaisl/index.html',
  '/letynaisl/admin.html',
  '/letynaisl/admin-login.html',
  '/letynaisl/calendar.html',
  '/letynaisl/setup-wizard.html',
  '/letynaisl/editar-negocio.html',
  '/letynaisl/manifest.json',
  '/letynaisl/icons/icon-72x72.png',
  '/letynaisl/icons/icon-96x96.png',
  '/letynaisl/icons/icon-128x128.png',
  '/letynaisl/icons/icon-144x144.png',
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/letynaisl/icons/icon-192x192.png');
          }
...
console.log('✅ Service Worker configurado para Lety Nails');
